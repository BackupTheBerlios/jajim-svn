 ...
 * @version 1.0.1
 * Clase oyente que escucha los eventos de rechaza de invitacion a un chat multi
 * usurario procedentes del servidor.
 */
public class RechazoInvitacionListener extends Observable implements InvitationRejectionListener{
     ...
     * @param observador El observador de la interfaz que será notificado de los
     * rechazos de invitación recibidos.
     */
    ...
    /**
     * Método que se ejecuta cada vez que se recibe una notificación de rechazo
     * de invitación, procedente del servidor.
