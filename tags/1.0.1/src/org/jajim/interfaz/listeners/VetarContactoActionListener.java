...
public class VetarContactoActionListener implements ActionListener{
    ...
    private VetarContactoFormulario vcf;
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de vetar el
     * contacto del formulario adecuado. Veta a los contactos de la conversación
     * en colaboración con el controlador de la conversación.
