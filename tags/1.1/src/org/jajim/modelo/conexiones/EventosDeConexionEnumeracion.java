...
public class EventosDeConexionEnumeracion{
    ...
    // Tipos de eventos
    public static final EventosDeConexionEnumeracion peticionDeSuscripcion = new EventosDeConexionEnumeracion("Petición de suscripción");
    public static final EventosDeConexionEnumeracion confirmacionDeSuscripcion = new EventosDeConexionEnumeracion("Confirmación de suscripción");
    public static final EventosDeConexionEnumeracion denegacionDeSuscripcion = new EventosDeConexionEnumeracion("Denegación de suscripción");
    public static final EventosDeConexionEnumeracion peticionDeChat = new EventosDeConexionEnumeracion("Petición de chat");
