 ...
 * @version 1.2 Clase que representa una ventana de un chat multiusuario. Inicializa la interfaz necesaria para que el
...
public class VentanaConversacionChatMultiusuario extends VentanaConversacion implements Observer {
    ...
    /**
     * Método que se ejecuta cada vez que se produce un evento de conversación im poretante.
     * <p>
