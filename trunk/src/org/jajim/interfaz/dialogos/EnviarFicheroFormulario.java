 ...
 * @version 1.2 Clase diálog que muestra un formulario al usuario para que rellene la informa cion necesaria para enviar
 * un fichero.
 */
public class EnviarFicheroFormulario extends JDialog implements ActionListener {
    ...
    private final JLabel etiquetaContactos;
    private final JLabel etiquetaFichero;
    private final JLabel etiquetaDescripcion;
    private final JCheckBox[] contactos;
    private final JTextField fichero;
    private final JTextArea descripcion;
    private final JButton botonFichero;
    ...
    public EnviarFicheroFormulario(VentanaConversacion vc) {
        ...
        botonAceptar.addActionListener(new EnviarFicheroActionListener(this, vc.getCvc()));
    ...
    /**
     * Método que se ejecuta cuando se produce uno de los eventos a los que está registrado la clase.
     * <p>
    ...
    public List<String> getCampos() {
        ...
        for (JCheckBox contacto : contactos) {
            if (contacto.isSelected()) {
                campos.add(contacto.getText());
            }
        }
