 ...
 * @version 1.2 Clase formulario, crea la interfaz para que el usuario pueda aceptar o rechazar uan invitación a un chat
 * multiusuario.
 */
public class AceptarORechazarInvitacionFormulario extends JDialog implements ActionListener {
    ...
    private final String idInvitacion;
    private final String room;
    private final String alias;

    /**
     * Constructor de la clase.Iniciliza las variables necesarias y crea la inter faz de usuario.
     * <p>
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción Aceptar del formulario. Lanza un formulario para que
     * el usuario introduzca el nick que va a usar.
     * <p>
