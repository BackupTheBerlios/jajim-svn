 ...
 * @version 1.2 Cuadro de diálogo para introducir el núevo valor de la contraseña.
 */
public class ModificarContraseñaFormulario extends JDialog implements ActionListener {
    ...
    /**
     * Constructor de la clase. Inicializa las variables necesarias. Crea la in terfaz del cuadro de diálogo.
     */
    ...
    /**
     * Método que se ejecuta cuando los usuarios seleccionan la opción Cancelar del cuadro de diálogo.
     * <p>
