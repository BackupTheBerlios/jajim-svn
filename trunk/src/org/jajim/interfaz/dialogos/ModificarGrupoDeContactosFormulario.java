 ...
 * @version 1.2 Clase formulario que recoge los datos que del grupo que el usuario desea modi ficar.
 */
public class ModificarGrupoDeContactosFormulario extends JDialog implements ActionListener {
    ...
    private final JTextField[] camposTexto = new JTextField[etiquetas.length];
    private final JButton botonAceptar;
    private final JButton botonCancelar;

    /**
     * Constructor de la clase. Inicializa las variables necesarias. Crea la inter faz del formulario.
     * <p>
    ...
    /**
     * Método que se ejecuta cuando se selecciona el botón Cancelar del cuadro de diálogo. Cierra el formulario.
     * <p>
