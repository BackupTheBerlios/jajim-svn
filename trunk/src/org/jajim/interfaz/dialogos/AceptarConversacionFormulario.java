...
import org.jajim.interfaz.listeners.AceptarConversacionActionListener;
 ...
 */
public class AceptarConversacionFormulario extends JDialog{
     ...
     */
    public AceptarConversacionFormulario(VentanaPrincipal vp,String idChat,String contacto){
        ...
        botonAceptar.addActionListener(new AceptarConversacionActionListener(this,vp,idChat,alias));
        botonRechazar = new JButton(rechazar);
        //botonRechazar.addActionListener(new RechazarContactoActionListener(this,vp.getCtc(),vp.getCcn(),contacto));
