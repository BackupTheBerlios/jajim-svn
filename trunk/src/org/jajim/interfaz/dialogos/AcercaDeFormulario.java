 ...
 * @version 1.2 Clase formulario que muestra información acerca de la herramienta.
 */
public class AcercaDeFormulario extends JDialog implements ActionListener {
    ...
    private final JLabel[] grupoDeValores = new JLabel[valores.length];
    private final JTextArea areaLicencia;
    private final JButton botonOK;

    /**
     * Constructor de la clase. Inicializa las variables necesarias y crea la interfaz de usuario.
     */
    public AcercaDeFormulario() {
        ...
        panelLicencia.setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.
            createEmptyBorder(0, 10, 10, 10), BorderFactory.createLineBorder(Color.gray, 1)), "GNU PUBLIC LICENSE"));
    ...
    /**
     * Método de la interaz ActionListener. Se ejecuta cuando el usuario selecciona la opción "Aceptar" del formulario.
