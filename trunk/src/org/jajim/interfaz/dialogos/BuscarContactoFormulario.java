 ...
 * @version 1.2 Formulario en el que el usuario puede realizar búsquedas de contactos.
 */
public class BuscarContactoFormulario extends JDialog implements ActionListener {
    ...
    private final JLabel cadenaResultados;
    private final JButton botonAñadirContacto;
    private final JTable conjuntoResultados;
    private final JButton botonBuscar;
    private final JButton botonCerrar;

    /**
     * Constructor de la clase. Inicializa las variables necesarias. Crea la in terfaz de usuario.
     */
    ...
    /**
     * Se ejecuta cuando el usuario selecciona el botón Cerrar del cuadro del for mulario. Cierra el mismo o lanza el
     * formulario de soicitud de contacto.
     * <p>
    ...
    /**
     * Método que se ejecuta una vez que se ha conseguido un resultado. Actualiza la tabla de resultados.
     * <p>
