 ...
 * @version 1.2 Clase formulario que permite cambiar el estilo de la fuente que se está utili zando en una conversación.
 */
public class FuenteFormulario extends JDialog implements ListSelectionListener, ActionListener {
    ...
    private final String[] tiposTamaño
    ...
    /**
     * Constructor de la clase. Inicializa la variables necesarias y crea la inter faz de usuario.
     * <p>
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona un elemento de cualquie ra de las listas. Actualiza el valor
     * del cuadro de muestra.
     * <p>
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        String cadena = "<center><font style=\"font-family:" + fuente + ";font-size:" + tamaño + "\">" + textoPrueba
            + "</font></center>";
