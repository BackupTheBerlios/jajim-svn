 ...
 * @version 1.2 Clase que crea un interfaz general para poder introducir los datos de una cuenta. Se registra como
 * oyente de eventos, aunque la información especifica para cada evento la recoge cada una de las clases derivadas.
 */
public class CuentaFormulario extends JDialog implements ActionListener {
    ...
    /**
     * Constructor de la clase. Crea la interfaz genérica para la introducción de los datos de una cuenta.
     * <p>
    ...
    /**
     * Método utilizado para obtener los campos introducidos por el usuario en el formulario.
     * <p>
    ...
    public List<String> getCampos() {
        ...
        for (JPasswordField contraseña1 : contraseña) {
            campos.add(new String(contraseña1.getPassword()));
        }
