 ...
 * @version 1.2 Clase diálogo que pregunta al usuario si quiere aceptar o rechazar la petición de contacto de un
 * usuario.
 */
public class AceptarORechazarContactoFormulario extends JDialog implements ActionListener {
    ...
    /**
     * Constructor de la clase. Inicializa las variables adecuadas. Crea la inter faz. Registra los oyentes adecuados.
     * <p>
     * @param contacto El usuario que desea establecer contacto con nuestro usua rio
     */
    ...
    /**
     * Método que se ejecuta cuando se selecciona el botón de aceptar contacto. Inicia el cuadro de diálogo de
