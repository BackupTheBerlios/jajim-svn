 ...
 * @version 1.2 Clase oyente que escucha los eventos de guardado de conversación procedentes del formulario habilitado a
 * tal efecto.
 */
public class GuardarConversacionActionListener implements ActionListener {

    private final GuardarConversacionFormulario gcf;
     ...
     */
    public GuardarConversacionActionListener(GuardarConversacionFormulario gcf, VentanaConversacion vc,
        ConversacionControlador cvc) {
        this.gcf = gcf;
        this.vc = vc;
        this.cvc = cvc;
    }
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de guardar con versación del formulario apropiado.
     * Intenta guardar la conversación en cola boración con el controlador de las conversaciones.
     * <p>
