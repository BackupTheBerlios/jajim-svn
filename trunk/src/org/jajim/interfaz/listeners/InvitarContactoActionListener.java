 ...
 * @version 1.2 Clase oyente que atiende las invitaciones a otros contactos para añadirse a la conversación. Dichas
 * peticiones provienen del formulario de invitar contactos.
 */
public class InvitarContactoActionListener implements ActionListener {

    private final InvitarContactoFormulario icf;
    ...
    /**
     * Método que se ejecuta cuando se selecciona la opción de invitar a los con tacto del formulario correspondiente.
     * Invita a los contactos a la conver sación en colaboración con el controlador de la conversación.
     * <p>
