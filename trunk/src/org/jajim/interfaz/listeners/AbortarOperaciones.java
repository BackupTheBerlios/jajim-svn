 ...
 * @version 1.2 Clase que se encarga de abortar la conexión, las conversaciones y las transfe rencias.
 */
public class AbortarOperaciones implements Runnable {
     ...
     * <p>
     * @return Un valor booleano que indica si se realizó la operación o se abor tó.
     */
    public boolean abortarConexion() {
        ...
        if (cnc.isConectado()) {
            int resultado = JOptionPane.showConfirmDialog(principal, texto.getString(
                "abortar_conexion_dialogo_principal"), texto.getString("abortar_conexion_dialogo_title"),
    ...
    public void abortarConversaciones() {
        ...
        if (VentanaConversacion.hayConversaciones()) {
            ...
            JOptionPane.showMessageDialog(principal, texto.getString("abortar_conversaciones_dialogo_principal"), texto.
                getString("abortar_conversaciones_dialogo_title"), JOptionPane.INFORMATION_MESSAGE);
    ...
    public void abortarConversaciones(String contacto) {
        ...
        if (VentanaConversacion.hayConversaciones()) {
            ...
            // Mostrar mensaje informando de que se van a cerrar todas las conversaciones
            JOptionPane.showMessageDialog(principal, texto.
                getString("abortar_conversaciones_dialogo_contacto_principal"), texto.getString(
                    "abortar_conversaciones_dialogo_title"), JOptionPane.INFORMATION_MESSAGE);
    ...
    public void abortarTransferencias() {
        ...
        if (vgt.getEstado() == VentanaGestorDeTransferencias.CON_TRANSFERENCIAS) {
            ...
            JOptionPane.showMessageDialog(principal, texto.getString("abortar_transferencias_dialogo_principal"), texto.
                getString("abortar_transferencias_dialogo_title"), JOptionPane.INFORMATION_MESSAGE);
     ...
     * @param dialogo  Valor booleano que indica si es necesario mostrar el cuadro de diálogo en el que se informa de
     *                 que se van a cerrar las transferencias o no.
     */
    public void abortarTransferencias(String contacto, boolean dialogo) {
        ...
        if (vgt.getEstado() == VentanaGestorDeTransferencias.CON_TRANSFERENCIAS) {
            ...
            // Mostrar mensaje informando de que se van a cerrar todas las transferencias
            if (dialogo) {
                JOptionPane.showMessageDialog(principal, texto.getString(
                    "abortar_transferencias_dialogo_contacto_principal"), texto.getString(
                        "abortar_transferencias_dialogo_title"), JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    /**
     * Desconecta al usuario de la conexión. Se crea un hilo porque dicha opera ción puede tardar, en caso de tener
