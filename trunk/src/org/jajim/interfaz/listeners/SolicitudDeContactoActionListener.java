 ...
 * @version 1.2 Clase que se activa cuando se selecciona la opción de añadir contacto. Dialoga con el controlador para
 * que lleve a cabo dicha operación.
 */
public class SolicitudDeContactoActionListener implements ActionListener {

    private final SolicitudDeContactoFormulario sdcf;
    ...
    /**
     * Método que se ejecuta cuando se selecciona el botón Aceptar del cuadro de diálogo de añadir contacto. Llama al
     * controlador para que realice las ope raciones adecuadas.
     * <p>
     * @param e
     */
    @Override
