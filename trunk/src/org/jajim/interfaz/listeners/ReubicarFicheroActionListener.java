 ...
 * @version 1.2 Clase oyente que escucha los eventos para mover un fichero procedentes del for mulario habilitado para
 * introducir la nueva ruta del fichero.
 */
public class ReubicarFicheroActionListener implements ActionListener {

    private final ReubicarFicheroFormulario rff;
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción Aceptar del formulario de reubicación de ficheros.
     * <p>
