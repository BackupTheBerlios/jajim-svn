 ...
 * @version 1.2 Clase oyente que se activa para realizar las operaciones relativas a la desconexión del sistema.
 */
public class DesconectarActionListener implements ActionListener, Runnable {
    ...
    /**
     * Método que se ejecuta cuando se selecciona la opción de desconectarse del servidor. Cancela las conversaciones y
     * las transferencias y cierra la cone xión.
     * <p>
    ...
    /**
     * Se ocupa de desconectar al usuario. Se hace en otro hilo, para que la in terfaz se actualice rápidamente.
     */
    @Override
    public void run() {
