 ...
 * @version 1.2 Clase oyente que se ejecuta cuando se selecciona la opción aceptar del cuadro de diálogo de aceptar
 * contacto. Utiliza los controladores para dar de alta al contacto.
 */
public class AceptarContactoActionListener implements ActionListener {

    private final AceptarContactoFormulario acf;

    /**
     * Constructor de la clase. Inicializa las variables necesarias.
     * <p>
     * @param acf El formulario de aceptación de contactos.
     */
    ...
    /**
     * Método que se ejecuta cuando se selecciona la opción aceptar del cuadro de diálogo de aceptar contacto. Utiliza
     * los controladores para dar de alta al contacto.
     * <p>
