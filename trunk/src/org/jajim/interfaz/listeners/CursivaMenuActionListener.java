 ...
 * @version 1.2 Clase que escucha los eventos de activació o desactivación de cursiva proceden tes de la ventana de la
 * conversación.
 */
public class CursivaMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario activa o desactiva la opción cursi va de los mensajes. Actualiza las
     * preferencias.
     * <p>
