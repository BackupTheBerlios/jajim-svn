 ...
 * @version 1.2 Clase oyente que escucha los eventos de eliminación de grupo provenientes del panel de contactos.
 */
public class EliminarGrupoDeContactosActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción Eliminar grupo del panel de contactos. Intenta
     * llevar a cabo la operación en colaboración con el controlador de contactos.
     * <p>
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            new MensajeError(VentanaPrincipal.getInstancia(), "imposible_eliminar_grupo_por_defecto_error",
                MensajeError.WARNING);
        }
    }
}
