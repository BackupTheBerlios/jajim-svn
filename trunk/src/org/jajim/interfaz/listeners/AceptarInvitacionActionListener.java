 ...
 * @version 1.2 Clase oyente que escucha los eventos de aceptación de invitación provenientes de el formulario que
 * permite intorducir el nick del usuario.
 * <p>
 */
public class AceptarInvitacionActionListener implements ActionListener {

    private final IntroducirNickFormulario inf;
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción Aceptar del formulario de introducción de nick.
     * Acepta la invitación de conversación pendiente.
     * <p>
