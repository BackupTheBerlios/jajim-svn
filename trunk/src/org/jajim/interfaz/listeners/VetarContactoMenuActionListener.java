 ...
 * @version 1.2 Clase oyente que escucha los eventos de rechazo de conexión provenientes del menú de la conversación.
 */
public class VetarContactoMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando se seleccion la opción de vetar un contacto presente en el menú de la ventana de la
     * conversación. Lanza el formulario adecuado para introducir los contactos a vetar.
     * <p>
     * @param e
     */
    @Override
