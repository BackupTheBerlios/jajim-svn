 ...
 * @version 1.2 Clase oyente que escucha los eventos de invitación de contactos procedentes del menú de la ventana de la
 * conversación.
 */
public class InvitarContactoMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de invitar con tacto a la conversación del menú
     * principal de la ventana de la conversación. Abre un formulario para que el usuario introduzca a quien quiere
     * invitar.
     * <p>
