 ...
 * @version 1.2 Clase oyente que escucha los eventos para abrir el gestor de transferencias, procedentes de la ventana
...
public class LanzarGestorDeTransferenciasActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción del Gestor de transferencias del menú de la
     * aplicación principal. Hace visible el gestor de transfererencias.
     * <p>
