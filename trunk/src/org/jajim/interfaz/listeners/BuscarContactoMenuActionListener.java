 ...
 * @version 1.2 Clase que escucha los eventos de búsqueda de usuarios procedentes del menú de la ventana principal.
 */
public class BuscarContactoMenuActionListener implements ActionListener {
    ...
    /**
     * Se ejecuta cuando se selecciona la opción Buscar contacto del menú princi pal de la aplicación. Lanza el cuadro
