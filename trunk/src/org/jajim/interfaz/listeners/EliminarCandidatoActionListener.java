 ...
 * @version 1.2 Clase oyente que se activa cuando el usuario selecciona el botón Aceptar del cuadro de diálogo que
 * informa de que una petición de contacto ha sido rechaza da.
 */
public class EliminarCandidatoActionListener implements ActionListener {

    private final PeticionRechazadaFormulario prf;
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona el botón Aceptar del cuadro de diálogo que informa de que una
     * petición de contacto ha sido re chazada. Borra el contacto de la lista de contactos.
     * <p>
