 ...
 * @version 1.2 Clase que escucha los eventos de modficación de letra en negrita procedentes de la ventana de la
 * conversación.
 */
public class NegritaMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona el botón que activa o desactiva la opción de texto en negrita.
