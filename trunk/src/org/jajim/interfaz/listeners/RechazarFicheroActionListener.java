 ...
 * @version 1.2 Clase oyente que reacciona cuando se desea rechazar la transferencia de un fi chero. Delega en el
 * controlador de las transferencias dicha operación.
 */
public class RechazarFicheroActionListener implements ActionListener {

    private final JDialog aorff;
    private final int idTransferencia;

    /**
     * Constructor de la clase. Inicializa las variables necesarias.
     * <p>
     * @param aorff           El formulario desde el que se generará el rechazo de la trans ferencia.
    ...
    /**
     * Método que se ejcuta cuando el usuario rehaza una trasnferencia de fichero. Utiliza el controlador de las
     * transferencias para llevar a cabo la operaci ón.
     * <p>
