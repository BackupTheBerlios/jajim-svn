 ...
 * @version 1.1 Clase que escucha las peticiones de envío de mensajes y las lleva a cabo.
 */
public class EnviarMensajeActionListener extends Observable implements ActionListener {
    ...
    /**
     * Operación que se ejecuta cuando se selecciona la opción de enviar mensaje de la herramienta. Actualiza la
     * interfaz con el nuevo mensaje y delega en el controlador el envío del mensaje a todos los miembros de la
     * conversaci ón.
     * <p>
