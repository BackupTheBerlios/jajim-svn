 ...
 * @version 1.2 Clase oyente que se ejecuta cuando se modifica el estado de una conexión. En vía su nuevo estado al
 * resto de contactos.
 */
public class CambiarEstadoActionListener implements ActionListener {
    ...
    private final String[] valoresEstado = {
        "available",
        "away",
        "chat",
        "dnd",
    ...
    /**
     * Método que se ejecuta cuando se selecciona un nuevo estado del combo de es tados.
     * <p>
