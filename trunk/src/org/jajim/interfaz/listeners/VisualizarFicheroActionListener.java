 ...
 * @version 1.2 Clase oyente que escucha los eventos de visualización de fichero procedentes de la barra de acciones del
 * gestor de ventanas.
 */
public class VisualizarFicheroActionListener implements ActionListener {
     ...
     */
    public VisualizarFicheroActionListener() {
    }

    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de visualizar el documento, disponible en la barra
     * de acciones del gestor de transferen cias. LLama al controlador para poder visualizar el fichero.
     * <p>
