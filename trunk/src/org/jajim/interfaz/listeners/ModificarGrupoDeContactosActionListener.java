 ...
 * @version 1.2 Clase oyente que escucha las peticiones de modificación de grupo provenientes del formulario de
 * modificación de grupo.
 */
public class ModificarGrupoDeContactosActionListener implements ActionListener {

    private final ModificarGrupoDeContactosFormulario mgdcf;
    ...
    /**
     * Método que se ejecuta cuando se selecciona el botón Aceptar del formulario de modificación de grupos. Intenta
     * modificar el nombre del grupo en cola boración con el controlador de los contactos.
     * <p>
