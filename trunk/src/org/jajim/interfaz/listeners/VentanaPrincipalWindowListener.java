...
public class VentanaPrincipalWindowListener extends WindowAdapter {
    ...
    public void windowClosing(WindowEvent e) {
        ...
        // Gestor de cuentas
        p = VentanaGestorDeCuentas.getInstancia().getLocation();
    ...
    /**
     * Método que se ejecuta cuando se minimiza una ventana. La oculta para que sólo sea accesible desde la barra de
     * herramientas.
     * <p>
    ...
    /**
     * Método que se ejecuta cuando se desactiva la ventana. Intenta cerrar los menús popup si estaban abiertos.
     * <p>
