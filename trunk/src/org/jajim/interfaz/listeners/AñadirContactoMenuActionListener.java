 ...
 * @version 1.2 Clase oyente que se ejecuta cuando el usuario selecciona la opción de Añadir contacto. Crea un cuadro de
 * diálogo para introducir los valores del contacto.
 */
public class AñadirContactoMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando se selecciona la opción de añadir contacto. Crear un formulario para introducir los
     * datos.
     * <p>
