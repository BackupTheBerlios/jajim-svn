 ...
 * @version 1.2 Oyente que escucha los eventos de eliminación de un contacto de un grupo prove nientes de el menú popup
 * del panel de contactos.
 */
public class EliminarContactoDeGrupoActionListener implements ActionListener {
     ...
     */
    public EliminarContactoDeGrupoActionListener() {
    }

    /**
     * Método que se ejecuta cuando se selecciona la opción de eliminar contacto de grupo de el menú popup del panel de
     * contactos. Elimina el contacto del grupo en colaboración con el controlador de contactos.
     * <p>
     * @param e
     */
    @Override
