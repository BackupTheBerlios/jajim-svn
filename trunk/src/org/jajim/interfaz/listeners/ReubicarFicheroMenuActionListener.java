 ...
 * @version 1.2 Clase oyente que escucha los eventos de reubicación de fichero procedentes del gestor de transferencias.
 */
public class ReubicarFicheroMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de Reubicar fichero disponible en la ventana del
     * gestor de transferencias. Lanza un formulario para que el usuario introduzca la nuevo ruta del documento.
     * <p>
