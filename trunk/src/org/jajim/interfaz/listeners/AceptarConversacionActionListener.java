...
import org.jajim.interfaz.dialogos.AceptarConversacionFormulario;
 ...
 */
public class AceptarConversacionActionListener implements ActionListener{

    private AceptarConversacionFormulario acf;
     ...
     * veración.
     */
    public AceptarConversacionActionListener(AceptarConversacionFormulario acf,VentanaPrincipal vp,String idChat,String alias){
        this.acf = acf;
        this.vp = vp;
        this.idChat = idChat;
        this.alias = alias;
