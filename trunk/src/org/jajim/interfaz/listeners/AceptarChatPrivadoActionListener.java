 ...
 * @version 1.2 Clase oyente que escucha los eventos de aceptar conversación provenientes del formulario
 * correspondiente.
 */
public class AceptarChatPrivadoActionListener implements ActionListener {

    private final AceptarORechazarChatPrivadoFormulario acf;
     ...
     * @param alias  El alias del contacto con el que se quiere establecer una con veración.
     */
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de aceptar con tacto del formulario provisto para
     * dicha función. Lanza una nueva conversa ción con el contacto apropiado.
     * <p>
