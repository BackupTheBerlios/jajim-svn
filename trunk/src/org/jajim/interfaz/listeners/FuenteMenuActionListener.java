 ...
 * @version 1.2 Clase oyente que escucha los eventos de modificación de fuente provenientes de el menú de estilo de la
...
public class FuenteMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción para cambiar la fuente del menú de estilos de la
     * ventana de la conversación. Lanza un formulario para cambiar la fuente.
     * <p>
