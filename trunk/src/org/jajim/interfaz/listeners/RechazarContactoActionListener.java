 ...
 * @version 1.2 Clase oyente que actúa cuando el usuario selecciona la opción de Rechazar pe tición de contacto del
 * sistema.
 */
public class RechazarContactoActionListener implements ActionListener {

    private final JDialog aorcf;
     ...
     * @param contacto El contacto que se va a rechazar.
     */
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona la opción de "Rechazar" contacto. Lleva a cabo dicha
     * operación.
     * <p>
