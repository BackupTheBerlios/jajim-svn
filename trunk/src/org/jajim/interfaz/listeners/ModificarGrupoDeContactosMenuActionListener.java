 ...
 * @version 1.2 Clase oyente que escucha los eventos de modificación de grupo provenientes de el menú popup de los
 * grupos.
 */
public class ModificarGrupoDeContactosMenuActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando se selecciona la opción Modificar grupo del menú popup de los grupos. Lanza el
     * cuadro de diálogo en el que el usuario puede modificar el grupo.
     * <p>
