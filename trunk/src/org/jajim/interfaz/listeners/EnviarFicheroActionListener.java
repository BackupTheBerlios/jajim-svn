 ...
 * @version 1.2 Clase oyente que interactua con el controlador de las transferencias para en viar un fichero cuando se
 * activa el botón Aceptar del formulario de envío de ficheros.
 */
public class EnviarFicheroActionListener implements ActionListener {

    private final EnviarFicheroFormulario eff;
    ...
    /**
     * Método que se ejecuta al pulsar el botón de Aceptar del formulario de en vío de ficheros. Interactúa con el
     * controlador correspondiente para reali zar el envío del fichero.
     * <p>
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            VentanaGestorDeTransferencias.getInstancia().añadirTransferenciaDeFichero(nombre, id,
                VentanaGestorDeTransferencias.EMISOR);
