 ...
 * @version 1.2 Clase oyente que escucha los eventos de rechazo de chat privado, procedentes del formulario habilitado
 * para dicha función.
 */
public class RechazarChatPrivadoActionListener implements ActionListener {

    private final AceptarORechazarChatPrivadoFormulario acpf;
    private final String idChat;

    /**
     * Constuctor de la clase. Inicializa las variables necesarias.
     * <p>
     * @param acpf   El formulario donde se sugiere aceptar o rechazar la petción de chat.
    ...
    /**
     * Método que se ejecuta cuando se selecciona la opción de rechazar chat en el formulario disponible para gestionar
     * esta tarea. Rechaza la petición de chat en colaboración con el controlador de las conversaciones.
     * <p>
