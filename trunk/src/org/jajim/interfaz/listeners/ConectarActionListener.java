 ...
 * @version 1.2 Clase que oyente que se activa cuando el usuario selecciona alguna de las opcio nes para conectarse con
 * el servidor. Gestiona el intercambio de información en tre la interfaz y el controlador.
 */
public class ConectarActionListener implements ActionListener {
    ...
    /**
     * Método que se ejecuta cuando el usuario selecciona una de las opciones de conectar con el servidor.
     * <p>
