 ...
 * @version 1.2 Clase que presenta el editor en el que se muestra los mensajes intercambiados entre los miembros de la
 * conversación. Se ocupa de actualizar los mensajes de la misma.
 */
public class PanelConversacion implements Observer {
    ...
    /**
     * Constructor de la clase. Inicializa las variables necesarias y crea la presentación.
     * <p>
     * @param vc La ventana de la conversación que tiene el panel.
     */
    public PanelConversacion(VentanaConversacion vc) {
        ...
        eventosConversacion.put(EventosConversacionEnumeracion.participanteAñadido, texto.getString(
            "añadir_participante_evento"));
        eventosConversacion.put(EventosConversacionEnumeracion.invitacionRechazada, texto.getString(
            "rechazo_invitacion_evento"));
        eventosConversacion.put(EventosConversacionEnumeracion.participanteDesconectado, texto.getString(
            "participante_desconectado_evento"));

        // Iniciar las cadenas de los eventos de la conexión
        eventosConexion = new HashMap<>();
        eventosConexion.put(EventosDeConexionEnumeracion.usuarioConectado, texto.getString(
            "usuario_conectado_evento_conversacion"));
        eventosConexion.put(EventosDeConexionEnumeracion.usuarioDesconectado, texto.getString(
            "usuario_desconectado_evento_conversacion"));
    ...
    private StringBuffer getMensaje(String usuario, String contenido, String[] estilo) {
        ...
        final String inicioMensaje = "<font style=\"font-family:" + fuente + ";font-size:" + tamaño + ";color:rgb("
            + rojo + "," + verde + "," + azul + ")" + ((negrita) ? ";font-weight:bold" : "") + ((cursiva)
            ? ";font-style:italic" : "") + "\">";
    ...
    public StringBuilder getConversacion() {
        ...
        String cabeceraGuardado
            = "<html><body><head><meta http-equiv=\"Content-Type\" content=\"text/html;charset=iso-8859-1\" /></head>";
    ...
    /**
     * Muestra un mensaje informando al usuario del evento de conversación producido.
     * <p>
     ...
     * <p>
     * @param eventoConFormato Cadena que incluye tanto información del evento, como el formato que este tiene.
     */
    ...
    /**
     * Método que actualiza las preferencias del usuario actual de la conversaci ón.
     * <p>
