...
public abstract class VentanaPopup implements MouseListener, ActionListener {
    ...
    /**
     * Metodo de la interfaz MouseListener. Se ejecuta cuando se pulsa el ratón en la ventana.
     * <p>
     * @param e El evento que produce la ejecución del método.
     */
    @Override
    ...
    /**
     * Metodo de la interfaz MouseListener. Se ejecuta cuando se suelta el ratón en la ventana.
     * <p>
     * @param e El evento que produce la ejecución del método.
     */
    @Override
    ...
    /**
     * Metodo de la interfaz MouseListener. Se ejecuta cuando se introduce el ratón en la ventana.
     * <p>
     * @param e El evento que produce la ejecución del método.
     */
    @Override
    ...
    /**
     * Metodo de la interfaz MouseListener. Se ejecuta cuando se saca el ratón en la ventana.
     * <p>
     * @param e El evento que produce la ejecución del método.
     */
    @Override
    ...
    /**
     * Método de la interfaz ActionListener. Se ejecuta cuando pasan 15 segundos sin que se pinche la ventana. Actualiza
     * el estado de la ventana y la cierra.
     * <p>
     * @param e El evento que produce la ejecución del método.
     */
    @Override
    ...
    /**
     * Método que espera hasta que se seleccione la ventana popup o hasta que se pase su tiempo de activación.
     * <p>
     * @return true si se ha seleccionado la ventana o false si se termina su tiempo de activación.
     */
