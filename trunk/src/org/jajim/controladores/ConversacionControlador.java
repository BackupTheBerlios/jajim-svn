 ...
 * @version 1.2 Clase que gestiona todas aquellas operaciones relacionadas con las conversacio nes.
 */
public abstract class ConversacionControlador {
     ...
     * @throws ImposibleEnviarMensajeException Si no se puede enviar el mensaje a los participantes en la conversación.
     */
    ...
    /**
     * Método que actualiza las preferencias en el controlador para que éste pueda enviarlas en el mensaje
     * correspondiente.
     * <p>
     ...
     * @throws FicheroNoEncontradoException          Si no se puede crear el fichero en el que se va a guardar la
     *                                               conversación
     * @throws ImposibleGuardarConversacionException Si no se puede guardar la con versación en el fichero.
     */
    public void guardarConversacion(String nombre, String ruta, String texto) throws FicheroNoEncontradoException,
        ImposibleGuardarConversacionException {
