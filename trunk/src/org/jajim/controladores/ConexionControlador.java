...
public class ConexionControlador{
    ...
    public Roster conectar(Observer observador) throws ServidorNoEncontradoException,ContraseñaNoDisponibleException,ImposibleLoginException,NoHayCuentaException{
        ...
        try{
            ...
            mdl.escribir("No se puede establecer login con la siguiente cuenta - Servidor: " + servidor + " - Identificador de cuenta: " + identificador);
     ...
     * @return Devuelve true en caso de que esté conectado y false en caso contra
     * rio.
     */
    ...
    /**
     * Cambio el estado en el que se encuentra el usuario con respecto a la cone
     * xión.
    ...
    /**
     * Inicia los oyentes de la conexión. Capturan paquetes importantes para la
     * funcionalidad de la aplicación.
     * @param observador El observador que será informado de la llegada de los pa
     * quetes importantes.
     */
