...
public class ConversacionControladorChatPrivado extends ConversacionControlador {
    ...
    private final MensajesChatPrivadoListener mcpl;

    /**
     * Constructor de la clase. Inicializa las variables necesarias.
     * <p>
     * @param usuario              El usuario con el que se va mantener el chat privado.
     * @param observadorDeMensajes El observador que será notificado de los mensa jes que lleguen al chat privado.
     */
     ...
     * <p>
     * @param idChat El identificador de la petición de chat.
     */
    ...
    public void enviarMensaje(String mensaje) throws ImposibleEnviarMensajeException {
        ...
        try {
            ...
            mdl.escribir("No se puede enviar el mensaje: " + mensaje + "- Conversación: " + conversacionPrivada.
                getParticipant());
