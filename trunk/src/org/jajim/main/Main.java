...
public class Main {
    ...
    /**
     * Método principal de la clase. Es el primer método que se ejecuta de la apli
     * cación.
    ...
    public static void main(String[] args) {
        ...
        UIManager.put("FileChooser.detailsViewButtonToolTipText",texto.getString("FileChooser.detailsViewButtonToolTipText"));
