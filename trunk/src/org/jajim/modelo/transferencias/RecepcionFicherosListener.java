 ...
 * @version 1.2 Clase que registra las peticiones de transferencia de ficheros provenientes de otros contactos.
 */
public class RecepcionFicherosListener extends Observable implements FileTransferListener {

    private int ID;
    private final Map<Integer, FileTransferRequest> peticiones;
    ...
    /**
     * Método que se ejecuta cuando se recibe una petición de transferencia. Re gistra la petición e informa a los
     * oyentes del evento.
     * <p>
    ...
    /**
     * Retorna la petición de transferencia recibida cuyo identificador se corres ponde con el aportado como parámetro.
     * <p>
