...
public class EventosConversacionEnumeracion {
    ...
    // Tipos de eventos
    public static EventosConversacionEnumeracion participanteAñadido = new EventosConversacionEnumeracion(
        "Se ha añadido un participante");
    public static EventosConversacionEnumeracion invitacionRechazada = new EventosConversacionEnumeracion(
        "Se ha rechazado la invitación");
    public static EventosConversacionEnumeracion participanteDesconectado = new EventosConversacionEnumeracion(
        "Un participante ha abandonado la conversación");
