 ...
 * @version 1.2 Oyente que se activa cuando se recibe una invitación de participación en un chat multiusuario.
 */
public class InvitacionListener extends Observable implements InvitationListener {

    private final Map<String, String[]> listaDeInvitaciones;
