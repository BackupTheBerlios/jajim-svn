 ...
 * @version 1.2 Cachea los mensajes recibidos en chats privados para recuperar, el primer mensaje de un chat privado.
 */
public class MensajesConversacionListener implements PacketListener {

    private final ColaSincronizadaConSobreescritura<Message> cscs;
    ...
    /**
     * Método que se ejecuta cada vez que se recibe un mensaje de conversación. Recupera el contenido del mensaje y lo
     * guarda en una pila.
     * <p>
    ...
    public void processPacket(Packet arg0) {
        ...
        if (s.compareTo("conf") == 0 || s.compareTo("conference") == 0 || s.compareTo("chat") == 0 || s.compareTo("muc")
            == 0) {
        }
        else {
            cscs.offer(m);
