 ...
 * @version 1.2 Clase que escucha los paquetes de presencia que llegan al cliente. Envía a la interfaz la información
 * necesaria en caso de tener que actuar
 */
public class PaquetePresenciaListener extends Observable implements PacketListener {

    private final XMPPConnection xc;
    private String origen;
    private final Roster contactos;
    ...
    /**
     * Método que se ejecuta cuando llega un paquete de presencia. En caso de ser relevante a nivel de interfaz se pasa
     * el mensaje a ella.
     * <p>
