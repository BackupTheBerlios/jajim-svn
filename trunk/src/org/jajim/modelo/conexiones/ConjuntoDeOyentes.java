 ...
 * @version 1.2 Clase que crea e inicializa todos los oyentes de paquetes necesarios para el correcto funcionamiento de
 * la herramienta.
 */
public class ConjuntoDeOyentes {

    private final PaquetePresenciaListener ppl;
