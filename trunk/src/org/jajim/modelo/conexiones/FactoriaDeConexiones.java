 ...
 * @version 1.2 Clase que maneja la creación y cacheado de las diferentes conexiones utilizadas por el sistema. Para sus
 * acceso se utiliza el patrón Singleton.
 */
public class FactoriaDeConexiones {
    ...
    /**
     * Método estático que permite recuperar una factoría de conexiones. Se usa para implementar el patrón Singlenton.
     * <p>
    ...
    /**
     * Obsoleto hasta que Smack solucione los problemas al cerrar una conexión y volver a abrirla. Método que devuelve
     * una conexión con el servidor especificado.
     * <p>
     * @param servidor El servidor con el que se quiere realizar la conexión.
     * @return Una conexión xmpp.
     * <p>
     * @throws ServidorNoEncontradoException Si no encuentra el servidor del que se quiere recuperar la conexión.
     */
    @Deprecated
    ...
    /**
     * Retorna siempre una conexión nueva. Es útil en algunos casos de uso que necesitan desconectarse antes de realizar
     * la operación y la conexión con el servidor almacenada en la caché puede estar corrrupta.
     * <p>
