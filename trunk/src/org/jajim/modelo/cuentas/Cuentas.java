...
public class Cuentas {
    ...
    /**
     * Crea una cuenta con la información especificada por los parámetros y la a
     * ñade a la lista de cuentas de la herramienta.
    ...
    /**
     * Devuelve verdadero en caso de existir cuentas asociadas y falso en caso con
     * trario.
    ...
    /**
     * Método que actualiza el valor de la cuenta cuyo identificador y servidor
     * se corresponden con los suministrados.
     * @param identificador El identificador de la cuenta.
    ...
    /**
     * Elimina la contraseña de una cuenta representada por se identificador u el
     * servidor donde está dada de alta.
     * @param identificador El identificador de la cuenta.
    ...
    /**
     * Recupera una contraseña del sistema en función del identificador y servidor
     * de la misma.
     * @param identificador El identificador de la cuenta.
    ...
    /**
     * Informa de si la contraseña de la cuenta representada por los valores pro
     * porcionados se almacena cifrada o sin cifrar.
     * @param identificador El identificador de la cuenta.
     * @param servidor El servidor donde está alojada la cuenta.
    ...
    /**
     * Método que retorna la cuenta que se corresponde con el identificador y el
     * servidor suministrados.
     * @param identificador El identificador de la cuenta.
     * @param servidor El servidor de la cuenta.
